...
class BootReceiver : BroadcastReceiver() {
    override fun onReceive(context: Context, intent: Intent) {
        ...
        if (receivedAction != Intent.ACTION_BOOT_COMPLETED &&
            ...
            receivedAction != "com.htc.intent.action.QUICKBOOT_POWERON"
        ) return
        ...
        val serviceIntent = Intent(context, CodespaceService::class.java)
        serviceIntent.action = CodespaceService.ACTION_START
